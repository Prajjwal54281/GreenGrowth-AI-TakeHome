...
export const HERO_FIELDS: ReturnField[] = [
  ...
  },
  {
    ...
    ai: {
      ...
      rationale:
        'The scan of this 1099-INT is low-contrast and Box 1 was partly faint. The read is a best guess, so please confirm against the document.',
    ...
    messages: [
      {
        ...
        authorRole: 'preparer',
        body: 'Officer comp looks low relative to distributions, so flagging for reasonable-compensation review once payroll lands.',
        visibility: 'internal',
        createdAt: addDays(NOW, -5),
      },
      {
...
export const HERO_REQUESTS: OutstandingRequest[] = [
  ...
  },
  {
    ...
    detail: 'The 1099-INT scan is low quality, so please confirm the amount.',
    cta: 'Confirm amount',
    owner: 'client',
    status: 'open',

...
export const AFFORDANCES: Record<AffordanceState, AffordanceMeta> = {
  ...
  verified: {
    ...
    text: 'text-aff-verified',
    bg: 'bg-aff-verified-bg',
    border: 'border-aff-verified-border',
    dot: 'bg-aff-verified',
    interactive: true,
  },
  editable: {
    ...
    text: 'text-aff-editable',
    bg: 'bg-aff-editable-bg',
    border: 'border-aff-editable-border',
    dot: 'bg-aff-editable',
    interactive: true,
  },
  'requires-approval': {
    ...
    text: 'text-aff-approval',
    bg: 'bg-aff-approval-bg',
    border: 'border-aff-approval-border',
    dot: 'bg-aff-approval',
    interactive: true,
  },
  locked: {
    ...
    text: 'text-aff-locked',
    bg: 'bg-aff-locked-bg',
    border: 'border-aff-locked-border',
    dot: 'bg-aff-locked',
    interactive: false,
  },
}
